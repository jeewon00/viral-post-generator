...
- 관심 분야에 "연애"가 포함되어 있으면 도파민 폭발하는 극적인 막장 스토리로 구성. 수위를 확 올려서 작성:
  * 배신/불륜/양다리/바람 현장 목격 등 충격적인 전개
  * "친구 남자친구가 나한테 고백했다", "여친 폰에서 전남친 톡 봤는데" 같은 극한 상황
  * 썸남/썸녀와의 밀당에서 반전 (알고 보니 이미 여친 있었음, 나만 썸인 줄 알았음 등)
  * 이별 후 복수/성장/재회 같은 감정 롤러코스터
  * 읽는 사람이 "헐 진짜?" "ㅋㅋㅋ 미쳤다" 하면서 몰입할 수 있는 디테일한 상황 묘사
